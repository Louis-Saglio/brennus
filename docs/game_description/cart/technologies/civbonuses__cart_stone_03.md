...
Data file: `simulation/data/technologies/civbonuses/cart_stone_03.json`.
...
Note: third stage of the "Mining Economy" civ bonus — see `civbonuses/cart_stone_01`.
