...
ROOT = Path("/home/ubuntu/brennus/sweeps/2026-09-06-0cae013")
...
def main():
    ...
    with (ROOT / "report.md").open("w") as f:
        ...
        f.write("Brennus (gaul, diff 3, aggressive) vs Petra (rome, diff 3, aggressive), "
                ...
                "45 min in-game limit, seed == aiseed. Run on 2026-09-06 via kiln, bot at commit 0cae013 (working tree clean at submission; bundle == bot/ at HEAD).\n\n")
