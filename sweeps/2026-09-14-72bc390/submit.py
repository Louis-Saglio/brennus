...
Sides: tweak = the capture change (bot/ at 72bc390), base = the pre-change
HEAD snapshot staged at tmp/capture-ab/bot-base (c9d0df8).
"""
import os
import sys
import json
...
SIDES = {
    "base": ("/home/ubuntu/brennus/tmp/capture-ab/bot-base", "capB-s"),
    "tweak": ("/home/ubuntu/brennus/bot", "capT-s"),
}
