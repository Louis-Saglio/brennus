/**
 * Brennus: AI bot for 0 A.D. — goal 9 stage: copy of the goal-8 bot, now
 * facing a real opponent (Petra, medium difficulty, defensive behaviour).
 * After the boom (city AND 300 pop) it spreads across the map to >= 70% of
 * the passable area and maxes out the food/wood stockpiles by 45 in-game
 * minutes. The `[HARNESS] brennus: loaded` banner is the headless smoke
 * test's canary.
 */
